                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span><a href="{{route('admin.comment.index')}}" class="btn
                        ...
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2>{{$comment->user()->value('first_name'). ' '.$comment->user()->value
                                        ('last_name')}}</h2>
                                        <p>{{$comment->comment}}</p>
                                    </div>

                                    <div class="col-md-12 mt-4 pt-4 border-top">
                                        <form action="{{route('admin.comment.answer', ['id'=>$comment->id])}}"
                                              method="post">
