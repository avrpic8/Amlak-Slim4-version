...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{sideBarActive(route('admin.ads.index'))}}"><a href="{{route('admin.ads.index')}}"><i
                            class="feather
            ...
            <li class="nav-item {{sideBarActive(route('admin.comment.index'))}}"><a href="{{route('admin.comment.index')
            }}"><i class="feather icon-calendar"></i><span class="menu-title"
                                                           data-i18n="Calender">نظرات</span></a>
            </li>
            <li class="nav-item {{sideBarActive(route('admin.user.index'))}}"><a href="{{route('admin.user.index')
            }}"><i class="feather
            icon-calendar"></i><span class="menu-title"
