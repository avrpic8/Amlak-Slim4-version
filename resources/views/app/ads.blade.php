                                ...
                                <?php foreach($relatedAds as $advertise) { ?>
                                    <div class="col-md-6 ftco-animate">
                                        <div class="properties">
                                            <a href="<?= route('home.ads', ['id' => $advertise->id]) ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url('<?= asset($advertise->image) ?>');">
