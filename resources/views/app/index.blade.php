...
@section('content')
                        ...
                        @foreach($newestAds as $advertise)
                            <div class="item">
                                <div class="properties">
                                    <a href="{{route('home.ads', ['id' => $advertise->id])}}" class="img d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="text p-3">
                                        ...
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="{{route('home.ads', ['id' => $advertise->id])}}">{{$advertise->address}}</a></h3>
                                                <p>{{$advertise->type()}}</p>
                                            </div>
                                            <div class="two">
    ...
    <section class="ftco-section bg-light">
        ...
        <div class="container-fluid">
            <div class="row">
                @foreach($bestAds as $advertise)
                    <div class="col-sm col-md-6 col-lg ftco-animate">
                        <div class="properties">
                            <a href="{{route('home.ads', ['id' => $advertise->id])}}" class="img img-2 d-flex
                            ...
                            <div class="text p-3">
                            <span class="status <?= $advertise->sellStatus() == 'اجاره' ? 'rent' : 'sale'?>">{{$advertise->sellStatus()
                            }}</span>
                                <div class="d-flex">
                                    <div class="one">
                        ...
                        <div class="blog-entry align-self-stretch">
                            ...
                            <div class="text mt-3 d-block">
                                ...
                                <div class="meta mb-3">
                                    ...
                                    <div><a href="#">{{$post->user()->value('first_name') . ' ' . $post->user()
                                    ->value('last_name')}}</a></div>
