            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-md-end align-items-center justify-content-end">
                    <div class="col-md-6 text p-4 ftco-animate" style="direction: rtl;">
                        <h1 class="mb-3">نارمک میدان ۷۲</h1>
                        <span class="location d-block mb-3"><i class="icon-my_location"></i> خیابان سوم</span>
                        <p>چشم انداز بسیار عالی و زیبا محیط آرام و ساکت پارکینگ بزرگ همسایگان خوب انباری بسیار بزرگ و
                            جادار همراه با آسانسور سه خواب افتابگیر.</p>
                        <span class="price">۱۰۰۰۰۰۰۰ تومان  </span>
                        <a href="#" class="btn-custom p-3 px-4 bg-primary">مشاهده جزئیات<span
                        ...
                        <div class="item">
                            <div class="properties">
                                ...
                                <div class="text p-3">
                                    ...
                                    <div class="d-flex">
                                        <div class="one">
                                            <h3><a href="#">فلکه صادقیه</a></h3>
                                            <p>آپارتمان</p>
                                        </div>
                                        <div class="two">
                                            <span class="price">۱۰۰۰۰۰۰ تومان</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('app.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saeed/Smart Electronics/Web/Amlak-slim4/resources/views/app/index.blade.php ENDPATH**/ ?>