...
<!-- END: Theme JS-->
<script src="<?= asset('admin-assets/js/scripts/datatables/datatable.js')?>"></script><?php /**PATH /home/saeed/Smart Electronics/Web/Amlak-slim4/resources/views/admin/layouts/scripts.blade.php ENDPATH**/ ?>