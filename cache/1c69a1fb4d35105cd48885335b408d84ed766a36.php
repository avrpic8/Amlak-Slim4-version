                                    ...
                                    <div class="card-body pt-1">
                                        <form action="<?= route('auth.login') ?>" method="post">
                                            ...
                                            <div class="form-group d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="text-right"><a href="<?php echo e(route('auth.forgot')); ?>" class="card-link">رمز  خود را فراموش کرده ام؟</a></div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saeed/Smart Electronics/Web/Amlak-slim4/resources/views/auth/login.blade.php ENDPATH**/ ?>